...
export function createPlaceMarker({
  ...
  label.style.cssText =
    `margin-bottom:2px;padding:2px 6px;border-radius:8px;background:#fff;color:#111;font-size:11px;font-weight:600;white-space:normal;text-align:center;width:80px;line-height:1.3;border:1.5px solid ${MARK_COLOR};box-shadow:0 1px 2px rgba(0,0,0,0.15);`;
