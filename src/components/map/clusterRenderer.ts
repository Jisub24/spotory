  ...
  render: ({ count, position }) => {
    ...
    div.innerHTML = `
      <svg width="45" height="45" viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg">
        <circle cx="120" cy="120" r="70" fill="#5EEAD4" opacity="0.6" />
        <circle cx="120" cy="120" r="90" fill="#5EEAD4" opacity="0.3" />
        <circle cx="120" cy="120" r="110" fill="#5EEAD4" opacity="0.2" />
        <circle cx="120" cy="120" r="130" fill="#5EEAD4" opacity="0.1" />
      </svg>
